...
- separate **proved**, **derived**, **inferred**, **hypothetical**, **unknown**, and **conflicting** claims;
...
|---|---|---|
| 1 | **How Gravity Can Explain the Collapse of the Wavefunction** (2025), arXiv:2510.11037 | Most recent paper found; connects quantum gravity, locality, measurement, and a testable collapse model. |
| 2 | **Taxonomy for Physics Beyond Quantum Mechanics** (2024), Proc. R. Soc. A 480, 20230779, arXiv:2309.12293 | Canonical terminology for superdeterministic, retrocausal, future-input-dependent, and related models. |
| 3 | **Quantum Confusions, Cleared Up (or so I hope)** (rev. 2024), arXiv:2309.12299 | Instrumental treatment of common quantum-foundations and locality claims. |
| 4 | **Bell's theorem allows local theories of quantum mechanics** (2022), Nature Physics 18, 1382, arXiv:2211.01331 | Central to the locality/statistical-independence distinction. |
| 5 | **What does it take to solve the measurement problem?** (2022), J. Phys. Commun. 6 102001, arXiv:2206.10445 | Defines what would count as solving the measurement problem. |
| 6 | **Comment on "Experimentally adjudicating..."** (2024), Phys. Rev. A 109, 026201, arXiv:2206.10619 | Directly relevant to fine-tuning, overfitting, and empirical discrimination. |
| 7 | **A Future-Input Dependent Path Integral for Quantum Mechanics** (2022), Annals of Physics 440, 168827, arXiv:2110.07168 | Mathematical machinery for future-input-dependent dynamics and collapse. |
| 8 | **A Toy Model for Local and Deterministic Wave-function Collapse** (2022), Phys. Rev. A 106, 022212, arXiv:2010.01327 | Concrete local deterministic model and statistical-independence violation. |
...
The normative contracts then load, in order:
